...
<div class="row">	
	<div class="col-lg-9">
		...
		<div id="AddBankRecordDiv" class="well">
			<?php echo $this->Form->create('Bank', array('url'=>'/banks/add/'));?>
				...
				<div style="float:left; clear:both;">
					<?php 				
					echo $this->Form->input('amount', array('type'=>'number', 'label'=>'Amount', 'required'=>true, 'title'=>'Amount', 'style'=>'width:100px;'));			
					?>
				</div>
				
				<div style="float:left; clear:none; margin-left:10px;">
					<?php echo $this->Form->input('title', array('label'=>'Description', 'type'=>'text', 'style'=>'width:250px;'));?>
				</div>				
				<div style="float:left; clear:none; margin-left:10px;">
					<br>
