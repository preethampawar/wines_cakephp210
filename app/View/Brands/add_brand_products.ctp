		...
		?>
			<tr>
				...
				<td>
					...
					echo $this->Form->input('brand_id.'.$product_id, array('type'=>'select', 'label'=>false, 'empty'=>' -- Select Brand -- ', 'required'=>false, 'options'=>$brands, 'selected'=>$selected_brand_id, 'class'=>'autoSuggest'));
					?>
				</td>
			</tr>
		<?php
