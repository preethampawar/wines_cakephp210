...
<h1>Edit Product: <?php echo $this->Html->link($productCategoryInfo['ProductCategory']['name'], array('controller'=>'products', 'action'=>'index', $productCategoryInfo['ProductCategory']['id']), array('title'=>'Show all products in '.$productCategoryInfo['ProductCategory']['name'].' category'));?> &raquo; <?php echo $productCategoryInfo['Product']['name'];?></h1>
...
<div id="EditProductDiv">
	...
	<div id="paramsDiv">
		<div style="float:left; clear:none;">
			<?php echo $this->Form->input('name', array('placeholder'=>'Enter Product Name', 'label'=>'Product Name', 'required'=>true, 'pattern'=>'[a-zA-Z0-9\s\-]{1,55}', 'title'=>'eg: Royal Challenge - Q, Kingfisher - P, etc.'));?>
		</div>
		<div style="float:left; clear:none;">
