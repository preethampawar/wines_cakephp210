...
<p><?php echo $this->Html->link('Cancel', array('controller'=>'purchases', 'action'=>'index'), array('title'=>'Go back to Purchase list'));?></p>
	...
	<div id="AddInvoiceProductDiv">
		...
		<div id="paramsDiv">			
			<div style="float:left; clear:none;">
				<?php echo $this->Form->input('product_id', array('empty'=>false, 'label'=>'Select Product', 'required'=>true, 'type'=>'select', 'options'=>$productsList, 'onchange'=>'setDefaultProductPrice(); setTotalPrice();', 'autofocus'=>true, 'class'=>'autoSuggest'));?>
			</div>
			<div style="float:left; clear:none;">
				<?php 
			...
			<div style="float:left; clear:both;">
				<?php echo $this->Form->input('purchase_date', array('label'=>'Purchase Date', 'required'=>true, 'type'=>'date'));?>
			</div>
			<div style="float:left; clear:none;">			
				<br><br> &nbsp;&nbsp;
