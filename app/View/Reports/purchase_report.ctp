...
<div id="paramsDiv">	
	<div style="float:left; clear:none;">
		<?php echo $this->Form->input('category_id', array('empty'=>'All', 'label'=>'Category', 'type'=>'select', 'options'=>$productCategoriesList, 'escape'=>false, 'onchange'=>'$("#PurchaseReportForm").removeAttr("target"); $("#PurchaseReportForm").removeAttr("action"); $("#PurchaseReportForm").submit();', 'style'=>'width:200px;'));?>
	</div>
	<div style="float:left; clear:none;">
