...
?>	
	<div id="AddSaleProductDiv" class="row">
		<div class="col-lg-8 col-md-10">
			<?php 
			echo $this->Form->create(null, array('validate'=>'validate'));		
			?>
				...
				?>
					<tr>
						...
						<td>		
							...
							<?php 						
							echo $this->Form->input('closing_stock_qty.'.$product_id, array('type'=>'number', 'min'=>'0', 'max'=>$stock, 'label'=>false, 'required'=>false, 'title'=>'Values should be between 0 to '.$stock, 'class'=>'form-control input-sm', 'div'=>false, 
			...
			<div class="submitLinkButton">
				<input type="button" class="submitLinkButton btn btn-warning btn-lg" value="Update Closing Stock" onclick='submitForm()'>				
			</div>
	...
	<style type="text/css">
		.submitLinkButton{ position: fixed; bottom: 10px; right: 10px; } 
	</style>
