		...
		<div>
			<table class="table">
				...
				<tr class="bold" style="border-top:2px solid #666; border-bottom:2px solid #666;">
					...
					<td><span
							class="balanceAmount"><?php echo $balance_amount = ($sale_amount - $expense_amount); ?></span>
					</td>
					<td>
						...
						<td>
							<div class="alignLeft">
								<form action="/reports/transactionLogReport" method="post" target="_blank">
									...
									<input type="hidden" name="data[Report][from_date][month]"
										   value="<?php echo $from_m; ?>">
									<input type="hidden" name="data[Report][from_date][day]"
										   value="<?php echo $from_d; ?>">

									<input type="hidden" name="data[Report][to_date][year]"
										   value="<?php echo $to_y; ?>">
									<input type="hidden" name="data[Report][to_date][month]"
										   value="<?php echo $to_m; ?>">
									<input type="hidden" name="data[Report][to_date][day]" value="<?php echo $to_d; ?>">
