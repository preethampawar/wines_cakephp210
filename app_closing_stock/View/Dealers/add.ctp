	...
	<table class='table search-table' style="width:100%">
		...
		foreach ($result as $row) {
			...
			<tr>
				...
				<td>
					<?php echo $this->Html->link('<span class="fa fa-pencil" aria-hidden="true"></span>', ['controller' => 'dealers', 'action' => 'edit', $dealer_id], ['title' => 'Edit Dealer - ' . $dealer_name, 'class' => 'btn btn-sm btn-warning', 'escape' => false]); ?>
					&nbsp;|&nbsp;
