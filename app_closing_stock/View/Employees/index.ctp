	...
	<table class='table' style="width:100%">
		...
		foreach ($employees as $row) {
			...
			<tr>
				...
				<td>
					<form method="post" style="" name="remove_employee_<?php echo $row['Employee']['id']; ?>"
						  id="remove_employee_<?php echo $row['Employee']['id']; ?>"
						  action="<?php echo $this->Html->url("/employees/remove/" . $row['Employee']['id']); ?>">
						...
						<input type="submit" value="Remove" name="Remove"
							   onclick="if (confirm('Deleting this Employee will also delete his/her salary information.\n\nAre you sure you want to delete this employee - <?php echo $row['Employee']['name']; ?> from the list?')) { $('#remove_employee_<?php echo $row['Employee']['id']; ?>').submit(); } event.returnValue = false; return false;"
							   class='small button link red'>
