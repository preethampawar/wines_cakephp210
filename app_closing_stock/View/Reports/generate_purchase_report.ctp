...
if ($result_allrecords) {
	...
	<table class='table'>
		...
		<tr>
			...
			<th colspan='2' style="text-align:right">Total
				Spl.Margin: <?php echo number_format($totalSplMarginAmount, 2, '.', ''); ?> </th>
			<th colspan='3' style="text-align:right">Total
				Amount: <?php echo number_format($totalAmount, 2, '.', ''); ?></th>
		</tr>
		<tr>
			<th colspan='12' style="text-align:right">Grand
				Total: <?php echo number_format(($totalSplMarginAmount + $totalAmount), 2, '.', ''); ?></th>
		</tr>
		</tfoot>
	</table>
	<?php
	...
	<table class='table'>
		...
		<tr>
			...
			<th colspan='2'
				style="text-align:right"><?php echo number_format(($totalSplMarginAmount + $totalAmount), 2, '.', ''); ?></th>
		</tr>
		</tfoot>
	</table>
	<?php
