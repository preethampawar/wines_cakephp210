...
<h1>
	...
	<span
		style="font-size:11px; font-style:italic;">[<?php echo $this->Html->link('Edit', ['controller' => 'suppliers', 'action' => 'edit', $supplierInfo['Supplier']['id']], ['title' => 'Edit ' . $supplierInfo['Supplier']['name']]); ?>]</span>
</h1>
